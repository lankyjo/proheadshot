...
// Fix: Changed default import to namespace import to resolve "no default export" error.
...
export const Ship = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M13 10l3-3m0 0l3 3m-3-3v12" />
  </svg>
);
